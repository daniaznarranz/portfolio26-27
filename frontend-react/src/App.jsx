...
const CvView = lazy(() => import('./CvView'));
...
function MailIcon({ size = 20, className = '', color = 'var(--color-primary, #FF6000)' }) {
  return (
    <svg
      width={size}
      height={size}
...
function WhatsAppIcon({ size = 20, className = '', color = 'currentColor' }) {
  return (
    <svg
      width={size}
      height={size}
...
function InstagramIcon({ size = 20, className = '', color = 'var(--color-primary, #FF6000)' }) {
  return (
    <svg
      width={size}
      height={size}
...
function MapPinIcon({ size = 20, className = '' }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
      className={className}
      style={{ display: 'inline-block', verticalAlign: 'middle', flexShrink: 0, color: 'var(--color-primary, #FF6000)' }}
      aria-hidden="true"
    >
...
function App() {
  ...
  useGSAP(() => {
    ...
    // 1. Preloader entrance animation (Optimized swift reveal)
    tl.fromTo('.preloader-char',
      ...
      // 2. Preloader exit (Fast exit slide up for immediate FCP/LCP)
    ...
    <div ref={mainRef}>
      ...
      <div className="app-root-content">
        {currentView === 'landing' ? (
                  ...
                  <div className="about-bento-grid">
                    ...
                    <div className="about-card about-card-main glass-card">
                      ...
                      <p className="about-card-text">
                        Soy Daniel Aznar, diseñador gráfico en Madrid con especial interés en entornos digitales. Me gusta entender bien cada proyecto antes de empezar, cuidar el proceso y llegar a soluciones pensadas y bien ejecutadas. Disfruto trabajando en equipo, comunicando de forma clara y aportando valor real, combinando criterio visual, tendencias actuales y una ejecución cuidada.
                      </p>
                    ...
                    <div className="about-card about-card-portrait glass-card">
                      ...
                      <div className="about-portrait-wrapper">
                        <img src={developerPortrait} alt="Developer Cutout Portrait" className="about-portrait-img" loading="lazy" decoding="async" />
                      </div>
                    </div>
                  ...
                  <div className="contact-card glass-card">
                    <div className="contact-info">
                      ...
                      <div className="contact-details">
                        ...
                        <div className="contact-detail-item">
                          <span className="contact-detail-icon">
                            <WhatsAppIcon size={20} color="var(--color-primary, #FF6000)" />
                          </span>
                          <a href="https://wa.me/34692449322?text=Hola%20Daniel%2C%20me%20gustar%C3%ADa%20consultar%20disponibilidad%20para%20un%20proyecto." target="_blank" rel="noopener noreferrer" className="contact-detail-link">+34 692 44 93 22</a>
                        </div>
                        <div className="contact-detail-item">
                          <span className="contact-detail-icon">
          ...
          <Suspense fallback={<div className="view-loading-placeholder" style={{ minHeight: '80vh' }} />}>
            {currentView === 'cv' ? (
              <ErrorBoundary onReset={() => navigateTo('landing')}>
